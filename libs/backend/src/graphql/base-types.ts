...
/** List of activity done by users */
...
/** List of activity done by users */
export type Activity_LogsMetadataArgs = {
  path?: InputMaybe<Scalars['String']['input']>;
};

/** aggregated selection of "activity.logs" */
...
/** aggregate fields of "activity.logs" */
...
/** order by aggregate values of table "activity.logs" */
...
/** input type for inserting array relation for remote table "activity.logs" */
...
/** Boolean expression to filter rows from the table "activity.logs". All fields are combined with a logical 'AND'. */
...
/** unique or primary key constraints on table "activity.logs" */
...
/** input type for inserting data into table "activity.logs" */
...
/** order by max() on columns of table "activity.logs" */
...
/** order by min() on columns of table "activity.logs" */
...
/** response of any mutation on the table "activity.logs" */
...
/** on_conflict condition type for table "activity.logs" */
...
/** Ordering options when selecting data from "activity.logs". */
...
/** primary key columns input for table: activity.logs */
...
/** select columns of table "activity.logs" */
...
/** input type for updating data in table "activity.logs" */
...
/** update columns of table "activity.logs" */
...
export type Mutation_Root = {
  ...
  deleteStores?: Maybe<Stores_Mutation_Response>;
  ...
  /** delete data from the table: "activity.logs" */
  delete_activity_logs?: Maybe<Activity_Logs_Mutation_Response>;
  /** delete single row from the table: "activity.logs" */
  delete_activity_logs_by_pk?: Maybe<Activity_Logs>;
  /** insert a single row into the table: "activity.logs" */
  insertActivityLog?: Maybe<Activity_Logs>;
  /** insert data into the table: "activity.logs" */
  insertActivityLogs?: Maybe<Activity_Logs_Mutation_Response>;
  ...
  insertStores?: Maybe<Stores_Mutation_Response>;
  ...
  updateStores?: Maybe<Stores_Mutation_Response>;
  ...
  /** update data of the table: "activity.logs" */
  update_activity_logs?: Maybe<Activity_Logs_Mutation_Response>;
  /** update single row of the table: "activity.logs" */
  update_activity_logs_by_pk?: Maybe<Activity_Logs>;
  /** update multiples rows of table: "activity.logs" */
...
/** mutation root */
export type Mutation_RootDeleteStoresArgs = {
...
/** mutation root */
export type Mutation_RootInsertActivityLogArgs = {
  object: Activity_Logs_Insert_Input;
  on_conflict?: InputMaybe<Activity_Logs_On_Conflict>;
};

/** mutation root */
export type Mutation_RootInsertActivityLogsArgs = {
...
/** mutation root */
export type Mutation_RootInsertStoreArgs = {
...
export type Query_Root = {
  ...
  /** fetch aggregated fields from the table: "activity.logs" */
  activityLogAggregate: Activity_Logs_Aggregate;
  /** fetch data from the table: "activity.logs" */
  activityLogs: Array<Activity_Logs>;
  /** fetch data from the table: "activity.logs" using primary key columns */
  activitylog?: Maybe<Activity_Logs>;
  ...
  storeAggregate: Stores_Aggregate;
  /** An array relationship */
  stores: Array<Stores>;
...
export type Query_RootActivityLogAggregateArgs = {
...
export type Query_RootStoreAggregateArgs = {
...
export enum Stores_Constraint {
  ...
  /** unique or primary key constraint on columns "website_url" */
  StoresWebsiteUrlKey = 'stores_website_url_key',
}
...
export type Subscription_Root = {
  ...
  /** fetch data from the table: "activity.logs" */
  activityLogs: Array<Activity_Logs>;
  /** fetch data from the table in a streaming manner: "activity.logs" */
...
export type Subscription_RootActivityLogAggregateArgs = {
  distinct_on?: InputMaybe<Array<Activity_Logs_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Activity_Logs_Order_By>>;
...
export type Subscription_RootStoreAggregateArgs = {
  distinct_on?: InputMaybe<Array<Stores_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Stores_Order_By>>;
